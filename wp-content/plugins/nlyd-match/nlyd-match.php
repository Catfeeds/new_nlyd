...
if(!class_exists('MatchController')){
    ...
    class MatchController{
        ...
        public function __construct($post_type)
        {
            ...
            define( 'leo_match_version','V2.1.7.0' );//样式版本
...
//                    break;
                ...
                case 'grading_options':
                    ...
                    break;
                case 'team_zone':
                    $zone_name = $wpdb->get_row("SELECT zm.zone_city,zm.zone_match_type,zm.zone_name,zm.type_id,zone_number FROM {$wpdb->prefix}team_meta AS tm 
                    ...
                    if($zone_name){
                        ...
                        $organizeClass->echoZoneName($type_alias,$zone_name['zone_city'],$zone_name['zone_name'],$zone_name['zone_match_type'],$zone_name['zone_number']);
                    }
                    break;
                default:
                    break;
