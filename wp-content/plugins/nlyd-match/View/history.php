<div class="wrap">
    <h1 class="wp-heading-inline">页面</h1>

    <a href="http://127.0.0.1/nlyd/wp-admin/post-new.php?post_type=page" class="page-title-action">新建页面</a>
    <hr class="wp-header-end">


    <h2 class="screen-reader-text">过滤页面列表</h2><ul class="subsubsub">
        <li class="all"><a href="edit.php?post_type=page" class="current" aria-current="page">全部<span class="count">（9）</span></a> |</li>
        <li class="publish"><a href="edit.php?post_status=publish&amp;post_type=page">已发布<span class="count">（8）</span></a> |</li>
        <li class="draft"><a href="edit.php?post_status=draft&amp;post_type=page">草稿<span class="count">（1）</span></a> |</li>
        <li class="trash"><a href="edit.php?post_status=trash&amp;post_type=page">回收站<span class="count">（1）</span></a></li>
    </ul>
