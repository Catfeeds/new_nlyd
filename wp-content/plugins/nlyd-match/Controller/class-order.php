...
<!--            </ul>-->
            <div>
                <ul id="tab">
                    ...
                    <li class="<?php if($orderType == 4) echo 'active'?>" onclick="window.location.href='?page=order&type=<?=$type?>&orderType=4'">课程订单</li>
                </ul>
            </div>
            <br class="clear">
            <br class="clear">
...
<!--                        </form>-->
    ...
    public function refundOrder(){
        ...
        WHEN 5 THEN "已失效"
        END AS pay_status,
        CASE o.order_type WHEN 1 THEN "报名订单" WHEN 2 THEN "考级订单" WHEN 3 THEN "课程订单" END AS order_type  
