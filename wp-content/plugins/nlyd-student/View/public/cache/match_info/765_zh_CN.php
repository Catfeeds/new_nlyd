...
<div class="nl-foot-nav flex-h">
    ...
    <a class="nl-foot-item flex1  " href="http://127.0.0.1/nlyd/matchs">
        <div class="nl-foot-icon">
        ...
        <div class="width-margin layui-row menu-wrapper">
            <div class="userCenter-detail layui-row layui-bg-white width-margin-pc">
                <a class="c_black8" href="http://127.0.0.1/nlyd/account/recentMatch">
                    ...
                    <a class="c_black8 disabled_a"  href="http://127.0.0.1/nlyd/account/matchList">
                        <div class="userCenter-detail-head">
                    ...
                    <a class="c_black8 disabled_a"  href="http://127.0.0.1/nlyd/account/secure">
                        <div class="userCenter-detail-head">
                    ...
                    <a class="c_black8 no_border" href="http://127.0.0.1/nlyd/safety/setting">
                        <div class="userCenter-detail-head">
                    ...
                    <a class="c_black8 no_border disabled_a"  href="http://127.0.0.1/nlyd/teams">
                        <div class="userCenter-detail-head">
                        ...
                        <ul class="flow-default">
                            <li class="nl-match">
                                ...
                                <div class="nl-match-header">
                                    <span class="nl-match-name fs_16 c_blue">pkjl</span>
                                ...
                                <div class="nl-match-body">
                                    <div class="nl-match-detail">
                                        ...
                                        <div class="nl-match-info c_black">
                                            2018-10-18 19:10                                            <span class="nl-match-type fs_12 c_orange "></span>
                                        </div>
                                    </div>
                                    <div class="nl-match-detail">
                                        <div class="nl-match-label">结束时间：</div>
                                        <div class="nl-match-info c_black">
                                            2018-10-18 21:05                                        </div>
                                    </div>
                                    <div class="nl-match-detail">
                                        <div class="nl-match-label">开赛地点：</div>
                                        <div class="nl-match-info c_black">成都天府广场</div>
                                    </div>
                                    <div class="nl-match-detail">
                                        <div class="nl-match-label">报名费用：</div>
                                        <div class="nl-match-info c_black">¥0.00</div>
                                    </div>
                                    <div class="nl-match-detail">
                                        <div class="nl-match-label">报名截止：</div>
                                        <div class="nl-match-info c_black" id="time_count"
                                             data-end="2018-10-18 19:04">已截止</div>
                            ...
                            <li class="nl-match">
                                <div class="nl-match-header">
                                    ...
                                    <span class="nl-match-people c_blue">位选手已报名</span>
                                </div>
                                <div class="nl-match-body">
                                    <div class="nl-table-wapper">
                                        <table class="nl-table">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table_content">头像</div>
                                                </td>
                                                <td>
                                                    <div class="table_content">学员姓名 </div>
                                                </td>
                                                <td>
                                                    <div class="table_content">性 别</div>
                                                </td>
                                                <td>
                                                    <div class="table_content">年龄</div>
                                                </td>
                                                <td>
                                                    <div class="table_content">报名日期</div>
                                                </td>
                                                <td>
                                                    <div class="table_content">国籍</div>
                                                </td>
                                            </tr>
                                            </thead>
                                            <tbody id="flow-table">
                                                        ...
                                                        <td>
                                                            <div class="table_content">20181018</div>
                                                        </td>
                                                        <td>
                                                            <div class="table_content">
                                                                <img src="http://127.0.0.1/nlyd/wp-content/plugins/nlyd-student/Public/css/image/flags/ec.png">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                                                                                                        </tbody>
