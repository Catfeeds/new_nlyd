        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <div class="layui-row nl-border nl-content">
                ...
                <div class="head-tips">特别提示</div>
                    <p class="content-p">脑力(中国)运动开发有限公司（以下简称“脑力中国”）在此特别提醒您（用户）在注册成为用户之前，请您认真阅读本《用户协议》（以下简称“协议”）并审慎选择接受或不接受本协议内容。同时，脑力中国特别提醒用户注意本协议中免除脑力中国责任和限制用户权利的条款。未成年人应在法定监护人的陪同下阅读本协议。您的注册、登录、使用等行为将视为对本协议的全部接受，并同意接受本协议全部条款的约束。</p>
                    <p class="content-p">本协议约定脑力中国与用户之间关于“脑力中国”互联网平台服务（以下简称“服务”）的权利义务。“用户”是指注册、登录、使用本服务的主体。本协议内容将由脑力中国进行随时更新，更新后的协议条款一经公布即代替原来的协议条款，而不再另行单独通知，用户可在本网站查阅最新版协议条款。在协议条款更新后，如果用户不接受更新后的条款，请立即停止使用脑力中国提供的服务，用户继续使用脑力中国提供的服务将被视为接受更新后的全部协议内容。</p>
