    ...
    <div class="layui-row">
        ...
        <div class="nl-right-content layui-col-sm12 layui-col-xs12 layui-col-md12 detail-content-wrapper">
            <header class="mui-bar mui-bar-nav">
                ...
                <h1 class="mui-title"><div><?=__('添加教练', 'nlyd-student')?></div></h1>
            </header>    
                ...
                <div class="width-padding width-padding-pc">
                    <form class="layui-form">
                        <div class="coach_add_row">
                            ...
                            <div>
                                <input class="radius_input_row nl-foucs" name="coach_id" value="" type="tel" lay-verify="phone" autocomplete="off" placeholder="<?=__('输入用户注册手机号码查询，未注册无法选择', 'nlyd-student')?>">
