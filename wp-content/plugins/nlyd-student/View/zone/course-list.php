                                    ...
                                    var dom='<li class="match_row">'
                                                ...
                                                +'<div class="match_body">'
                                                    ...
                                                    +'<div class="match_body_row">'
                                                        ...
                                                        +'<div class="match_body_info c_black">'+v.entry_total+' <a href="" class="c_blue ml_10">查看</a></div>'
                                                    +'</div>'
                                                +'</div>'
                                                +'<div class="match_footer ta_r">'
                                                    ...
                                                    +'<a href="<?=home_url('/zone/matchBuild/');?>" class="edit_match c_black6"><span class="c_blue"><i class="iconfont fs_20">&#xe654;</i></span><span class="ml_10">编辑课程</span></a>'
                                                +'</div>'
                                            +'</li>'
                                    lis.push(dom) 
                                })
