    ...
    <div class="width-padding layui-row width-margin-pc">
        <form class="layui-form apply_form" lay-filter='layform'>
            ...
            <div class="name_row dis_none">
                ...
                <div class="input_row">
                    <input class="radius_input_row nl-foucs" type="text" name="zone_name" autocomplete="off" placeholder="<?=__('绿色示例部分即为字号，限3-5字', 'nlyd-student')?>" value="<?=!empty($row['id']) ? $row['zone_name'] :''?>">
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="input_row">
                    <input class="radius_input_row change_num nl-foucs" name="chargeman_phone" value="<?=$row['chargeman_phone']?>" type="tel" lay-verify="phone" autocomplete="off" placeholder="<?=__('输入用户注册手机号码查询，未注册无法选择', 'nlyd-student')?>">
                </div>
            </div>
