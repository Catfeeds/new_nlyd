                            ...
                            if(res.success){
                                ...
                                $.each(res.data.info,function(i,v){
                                    ...
                                    var dom='<a class="profit_list c_black layui-row" href="'+Detail_url+'">'
                                                ...
                                                +'</div>'
                                                +'<div class="profit_inline profit_time">'
                                                    +'<span class="fs_14">'+v.income_type_title+'</span><br>'
                                                    +'<span class="c_black6 fs_14">'+v.created_time+'</span>'
                                                +'</div>'
                                                +'<div class="profit_inline profit_money">'
                                                    +'<span class="'+color+' fs_14">'+v.user_income+'</span><br>'
                                                    +'<span class="c_black6 fs_14">'+v.income_status+'</span>'
                                                +'</div>'
