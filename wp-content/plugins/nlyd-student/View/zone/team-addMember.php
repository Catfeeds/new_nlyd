                    ...
                    <form class="layui-form">
                        <div class="coach_add_row">
                            ...
                            <div class="coach_add_input">
                                ...
                                <input class="radius_input_row change_num" name="user_phone" value="<?=$row['user_phone']?>" type="tel" lay-verify="phone" autocomplete="off" placeholder="<?=__('输入用户注册手机号码查询，未注册无法选择', 'nlyd-student')?>">
                            </div>
