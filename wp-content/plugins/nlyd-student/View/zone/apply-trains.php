    ...
    <div class="layui-row">
        ...
        <div class="nl-right-content layui-col-sm12 layui-col-xs12 layui-col-md12 detail-content-wrapper have-bottom">
            <header class="mui-bar mui-bar-nav">
                ...
                <?php }else{ ?>
                <h1 class="mui-title"><div><?=__('训练中心资料填写', 'nlyd-student')?></div></h1>
                <?php } ?>
            </header>
                ...
                <div class="width-padding layui-row width-margin-pc">
                    <form class="layui-form apply_form" lay-filter='layform'>
                        <div>
                            ...
                            <div class="input_row">
                                <input class="radius_input_row nl-foucs" type="text" name="zone_name" autocomplete="off" placeholder="<?=__('填写训练中心名字，仅需填写绿色部分', 'nlyd-student')?>" value="<?=!empty($row['id']) ? $row['zone_name'] :''?>">
                            </div>
                        </div>
                        <div>
