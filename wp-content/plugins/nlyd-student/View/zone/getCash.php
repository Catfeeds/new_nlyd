                ...
                <div class="width-padding layui-row width-margin-pc">
                    ...
                    <form class="layui-form ">
                        <div class="getCash_type_row">
                            <input type="radio" name="getCash_type" value="bank" title="<?=__('提现至银行卡（民生银行 789***9080）', 'nlyd-student')?>">
                        </div>
                        <div class="getCash_type_row">
                            <input type="radio" name="getCash_type" value="wallet" title="<?=__('提现至平台账户钱包', 'nlyd-student')?>" checked>
                        </div>
                        ...
                        <a class="a-btn bg_gradient_green" lay-filter="layform" lay-submit=""><?=__('提 现', 'nlyd-student')?></a>
                    </form>
                </div>  
            </div>
        </div>            
