            ...
            <div class="layui-row nl-border nl-content">
                ...
                <div class="layui-row width-padding layui-bg-white">
                    <div class="top-nav">
                        ...
                        <div class="top-nav-btn"><a class="fs_16 c_black6" href="<?=home_url('/iisc-2');?>"><?=__('我 们', 'nlyd-student')?></a></div>
                        ...
                        $.each(res.data.info,function(i,v){
                            var dom= '<a class="course_row width-padding width-padding-pc c_black6" href="'+window.home_url+'/courses/cenerCourse/id/'+v.user_id+'/">'
                                        ...
                                        +'<div class="course_info">'
                                            +'<div class="course_info_row fs_16 c_black">'+v.zone_name+'训练中心'+v.content+'</div>'
