...
class Student_Directory_Zone_Train
{
    ...
    public function index(){
        ...
        if($conf['zoneTrainTime'] == $last_time && $conf['zoneTrainTermTime'] > $current_time && file_exists($file_name)){
...
//            leo_dump($rows);die;
            ...
            if($rows) {
                ...
                $conf['zoneTrainTime'] = $last_time;
                $conf['zoneTrainTermTime'] = get_time()+3600*24*30;
            }
