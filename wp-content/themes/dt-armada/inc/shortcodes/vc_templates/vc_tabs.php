...
if ( 'vc_tour' === $this->shortcode ) {
	$next_prev_nav = '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'presscore' ) . '">' . __( 'Previous tab', 'presscore' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'presscore' ) . '">' . __( 'Next tab', 'presscore' ) . '</a></span></div>';
} else {
	$next_prev_nav = '';
}
