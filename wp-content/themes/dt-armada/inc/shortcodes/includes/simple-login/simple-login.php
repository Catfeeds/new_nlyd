	...
	class DT_Shortcode_Simple_Login extends DT_Shortcode {
		...
		protected function get_wp_login_form( $args = array() ) {
			$defaults = array(
				...
				'form_id' => 'loginform',
				'label_username' => _x( 'Username', 'shortcode simple login', 'presscore' ),
				'label_password' => _x( 'Password', 'shortcode simple login', 'presscore' ),
				'label_remember' => _x( 'Remember Me', 'shortcode simple login', 'presscore' ),
				'label_log_in' => _x( 'Log In', 'shortcode simple login', 'presscore' ),
				'id_username' => 'user_login',
				'id_password' => 'user_pass',
				'id_remember' => 'rememberme',
				'id_submit' => 'wp-submit',
