...
if ( 'vc_tour' === $this->shortcode ) {
	$output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous slide', 'presscore' ) . '">' . __( 'Previous slide', 'presscore' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next slide', 'presscore' ) . '">' . __( 'Next slide', 'presscore' ) . '</a></span></div>';
}
