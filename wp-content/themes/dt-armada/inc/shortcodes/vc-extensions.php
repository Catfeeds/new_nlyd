...
if (class_exists('WPBakeryVisualComposerAbstract')) {
	...
	function presscore_compatible_vc_add_shortcode_param($name, $form_field_callback, $script_url = null ){
	...
	function presscore_vc_add_custom_fields() {
		...
		presscore_compatible_vc_add_shortcode_param('dt_taxonomy', 'presscore_vc_taxonomy_settings_field', $dir . '/inc/shortcodes/vc_extend/dt-vc-scripts.js' );
		presscore_compatible_vc_add_shortcode_param('dt_posttype', 'presscore_vc_posttype_settings_field', $dir . '/inc/shortcodes/vc_extend/dt-vc-scripts.js' );
	}
