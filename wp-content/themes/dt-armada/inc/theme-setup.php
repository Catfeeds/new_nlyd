...
if ( ! function_exists( 'presscore_setup' ) ) :
	...
	function presscore_setup() {
		...
		register_nav_menus( array(
			'primary' 	=> __( 'Primary Menu', 'presscore' ),
			'top'		=> __( 'Top Menu', 'presscore' ),
			'bottom'	=> __( 'Bottom Menu', 'presscore' ),
		) );
...
if ( ! function_exists( 'presscore_dt_paginator_args_filter' ) ) :
	...
	function presscore_dt_paginator_args_filter( $args ) {
		...
		$args['act_class'] = 'act';
		$args['next_text'] = _x( 'next', 'paginator', 'presscore' );
		$args['prev_text'] = _x( 'prev', 'paginator', 'presscore' );
