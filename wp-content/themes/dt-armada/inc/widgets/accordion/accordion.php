...
class Presscore_Inc_Widgets_Accordion extends WP_Widget {
	...
	function __construct() { 
		/* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Accordion', 'widget', 'presscore' ) );
		...
		parent::__construct(
			...
			DT_WIDGET_PREFIX . _x( 'Accordion', 'widget', 'presscore' ),
			$widget_ops,
			$control_ops
		);
	}
	...
	function form( $instance ) {
		...
		<div class="dt-widget-sortable-container">
			...
			<a href="javascript: void(0);" class="dt-widget-sortable-add" data-fields-name="<?php echo $this->get_field_name( 'fields' ); ?>" data-field-type="accordion"><?php _ex( 'Add', 'widget', 'presscore' ); ?></a>
		</div>
