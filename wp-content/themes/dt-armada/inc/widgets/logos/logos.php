...
class Presscore_Inc_Widgets_Logos extends WP_Widget {
	...
	function __construct() {  
		/* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Partners & clients', 'widget', 'presscore' ) );

		/* Create the widget. */
		parent::__construct(
			'presscore-logos',
			DT_WIDGET_PREFIX . _x( 'Partners & clients', 'widget', 'presscore' ),
			$widget_ops
		);
	}
...
apply_filters('dt_sanitize_order', $attributes['order']);
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _ex('Title (optional):', 'widget',  'presscore'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show' ); ?>"><?php _ex('Number of logos:', 'widget', 'presscore'); ?></label>
