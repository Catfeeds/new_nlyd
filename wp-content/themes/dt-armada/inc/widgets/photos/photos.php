...
class Presscore_Inc_Widgets_Photos extends WP_Widget {
	...
	function __construct() {  
		/* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Photos', 'widget', 'presscore' ) );

		/* Create the widget. */
		parent::__construct(
			'presscore-photos',
			DT_WIDGET_PREFIX . _x( 'Photos', 'widget', 'presscore' ),
			$widget_ops
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<strong><?php _ex('Show Photos from following categories:', 'widget', 'presscore'); ?></strong><br />
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show' ); ?>"><?php _ex('How many:', 'widget', 'presscore'); ?></label>
