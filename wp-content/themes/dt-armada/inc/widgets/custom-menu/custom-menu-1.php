...
class Presscore_Inc_Widgets_CustomMenu1 extends WP_Widget {
	...
	function __construct() {  
        /* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Custom menu style 1', 'widget', 'presscore' ) );

		/* Create the widget. */
        parent::__construct(
            'presscore-custom-menu-1',
            DT_WIDGET_PREFIX . _x( 'Custom menu style 1', 'widget', 'presscore' ),
            $widget_ops
        );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'menu' ); ?>"><?php _ex('Choose custom menu:', 'widget',  'presscore'); ?></label>
