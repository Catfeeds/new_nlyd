...
function sakura_widget_quickflickr_control() {
	...
	?>
	<p><label for="flickr-title"><?php _ex('Title:', 'widget', 'presscore'); ?> <input class="widefat" id="flickr-title" name="sakura-flickr-title" type="text" value="<?php echo $title; ?>" /></label></p>
	<p><label for="flickr-username"><?php _ex('Flickr Latest RSS URL:', 'widget', 'presscore'); ?> <input class="widefat" id="flickr-username" name="sakura-flickr-username" type="text" value="<?php echo $flickr_username; ?>" /></label></p>
	
    <p><label for="flickr-items"><?php _ex('How many items?', 'widget', 'presscore'); ?> <input type="text" class="widefat" id="rss-items" name="sakura-rss-items" value="<?php echo $items; ?>" /></label></p>
	
	<p><label for="flickr-tags"><?php _ex('Filter by tags (comma seperated):', 'widget', 'presscore'); ?> <input class="widefat" id="flickr-tags" name="sakura-flickr-tags" type="text" value="<?php echo $tags; ?>" /></label></p>
	
	<p><label for="flickr-random"><input id="flickr-random" name="sakura-flickr-random" type="checkbox" value="checked" <?php echo $random; ?> /> <?php _ex('Random pick', 'widget', 'presscore'); ?></label></p>
