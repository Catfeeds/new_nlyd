...
class Presscore_Inc_Widgets_Team extends WP_Widget {
	...
	function __construct() {  
		/* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Team', 'widget', 'presscore' ) );

		/* Create the widget. */
		parent::__construct(
			'presscore-team',
			DT_WIDGET_PREFIX . _x( 'Team', 'widget', 'presscore' ),
			$widget_ops
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>"><?php echo _ex('Show excerpt:', 'widget',  'presscore'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show' ); ?>"><?php _ex('Number of team members:', 'widget', 'presscore'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'autoslide' ); ?>"><?php _ex('Autoslide:', 'widget',  'presscore'); ?></label>
