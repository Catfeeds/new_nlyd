...
class Presscore_Inc_Widgets_TestimonialsSlider extends WP_Widget {
	...
	function __construct() {  
		/* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Testimonials slider', 'widget', 'presscore' ) );

		/* Create the widget. */
		parent::__construct(
			'presscore-testimonials-slider',
			DT_WIDGET_PREFIX . _x( 'Testimonials slider', 'widget', 'presscore' ),
			$widget_ops
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show' ); ?>"><?php _ex('Number of testimonials:', 'widget', 'presscore'); ?></label>
