...
class Presscore_Inc_Portfolio_Post_Type {
	...
	public static function register() {
		...
		// titles
		$labels = array(
			'name'                  => _x('Portfolio',              'backend portfolio', 'presscore'),
			'singular_name'         => _x('Portfolio',              'backend portfolio', 'presscore'),
			'add_new'               => _x('Add New',                'backend portfolio', 'presscore'),
			'add_new_item'          => _x('Add New Item',           'backend portfolio', 'presscore'),
			'edit_item'             => _x('Edit Item',              'backend portfolio', 'presscore'),
			'new_item'              => _x('New Item',               'backend portfolio', 'presscore'),
			'view_item'             => _x('View Item',              'backend portfolio', 'presscore'),
			'search_items'          => _x('Search Items',           'backend portfolio', 'presscore'),
			'not_found'             => _x('No items found',         'backend portfolio', 'presscore'),
			'not_found_in_trash'    => _x('No items found in Trash','backend portfolio', 'presscore'),
			'parent_item_colon'     => '',
			'menu_name'             => _x('Portfolio', 'backend portfolio', 'presscore')
		);
		...
		// titles
		$labels = array(
			'name'              => _x( 'Portfolio Categories',        'backend portfolio', 'presscore' ),
			'singular_name'     => _x( 'Portfolio Category',          'backend portfolio', 'presscore' ),
			'search_items'      => _x( 'Search in Category','backend portfolio', 'presscore' ),
			'all_items'         => _x( 'Portfolio Categories',        'backend portfolio', 'presscore' ),
			'parent_item'       => _x( 'Parent Portfolio Category',   'backend portfolio', 'presscore' ),
			'parent_item_colon' => _x( 'Parent Portfolio Category:',  'backend portfolio', 'presscore' ),
			'edit_item'         => _x( 'Edit Category',     'backend portfolio', 'presscore' ), 
			'update_item'       => _x( 'Update Category',   'backend portfolio', 'presscore' ),
			'add_new_item'      => _x( 'Add New Portfolio Category',  'backend portfolio', 'presscore' ),
			'new_item_name'     => _x( 'New Category Name', 'backend portfolio', 'presscore' ),
			'menu_name'         => _x( 'Portfolio Categories',        'backend portfolio', 'presscore' )
		);
...
class Presscore_Inc_Testimonials_Post_Type {
	...
	public static function register() {
		...
		// titles
		$labels = array(
			'name'                  => _x('Testimonials',              'backend testimonials', 'presscore'),
			'singular_name'         => _x('Testimonials',              'backend testimonials', 'presscore'),
			'add_new'               => _x('Add New Testimonial',                'backend testimonials', 'presscore'),
			'add_new_item'          => _x('Add New Testimonial',           'backend testimonials', 'presscore'),
			'edit_item'             => _x('Edit Testimonial',              'backend testimonials', 'presscore'),
			'new_item'              => _x('New Testimonial',               'backend testimonials', 'presscore'),
			'view_item'             => _x('View Testimonial',              'backend testimonials', 'presscore'),
			'search_items'          => _x('Search Testimonials',           'backend testimonials', 'presscore'),
			'not_found'             => _x('No Testimonials found',         'backend testimonials', 'presscore'),
			'not_found_in_trash'    => _x('No Testimonials found in Trash','backend testimonials', 'presscore'), 
			'parent_item_colon'     => '',
			'menu_name'             => _x('Testimonials', 'backend testimonials', 'presscore')
		);
		...
		// titles
		$labels = array(
			'name'              => _x( 'Testimonial Categories',        'backend testimonials', 'presscore' ),
			'singular_name'     => _x( 'Testimonial Category',          'backend testimonials', 'presscore' ),
			'search_items'      => _x( 'Search in Category','backend testimonials', 'presscore' ),
			'all_items'         => _x( 'Categories',        'backend testimonials', 'presscore' ),
			'parent_item'       => _x( 'Parent Category',   'backend testimonials', 'presscore' ),
			'parent_item_colon' => _x( 'Parent Category:',  'backend testimonials', 'presscore' ),
			'edit_item'         => _x( 'Edit Category',     'backend testimonials', 'presscore' ), 
			'update_item'       => _x( 'Update Category',   'backend testimonials', 'presscore' ),
			'add_new_item'      => _x( 'Add New Testimonial Category',  'backend testimonials', 'presscore' ),
			'new_item_name'     => _x( 'New Category Name', 'backend testimonials', 'presscore' ),
			'menu_name'         => _x( 'Testimonial Categories',        'backend testimonials', 'presscore' )
		);
...
class Presscore_Inc_Team_Post_Type {
	...
	public static function register() {
		...
		// titles
		$labels = array(
			'name'                  => _x('Team',              			'backend team', 'presscore'),
			'singular_name'         => _x('Teammate',              			'backend team', 'presscore'),
			'add_new'               => _x('Add New',                	'backend team', 'presscore'),
			'add_new_item'          => _x('Add New Teammate',           'backend team', 'presscore'),
			'edit_item'             => _x('Edit Teammate',              'backend team', 'presscore'),
			'new_item'              => _x('New Teammate',               'backend team', 'presscore'),
			'view_item'             => _x('View Teammate',              'backend team', 'presscore'),
			'search_items'          => _x('Search Teammates',           'backend team', 'presscore'),
			'not_found'             => _x('No teammates found',         'backend team', 'presscore'),
			'not_found_in_trash'    => _x('No Teammates found in Trash','backend team', 'presscore'), 
			'parent_item_colon'     => '',
			'menu_name'             => _x('Team', 'backend team', 'presscore')
		);
		...
		// titles
		$labels = array(
			'name'              => _x( 'Team Categories',        'backend team', 'presscore' ),
			'singular_name'     => _x( 'Team Category',          'backend team', 'presscore' ),
			'search_items'      => _x( 'Search in Team Category','backend team', 'presscore' ),
			'all_items'         => _x( 'Team Categories',        'backend team', 'presscore' ),
			'parent_item'       => _x( 'Parent Team Category',   'backend team', 'presscore' ),
			'parent_item_colon' => _x( 'Parent Team Category:',  'backend team', 'presscore' ),
			'edit_item'         => _x( 'Edit Team Category',     'backend team', 'presscore' ), 
			'update_item'       => _x( 'Update Team Category',   'backend team', 'presscore' ),
			'add_new_item'      => _x( 'Add New Team Category',  'backend team', 'presscore' ),
			'new_item_name'     => _x( 'New Team Category Name', 'backend team', 'presscore' ),
			'menu_name'         => _x( 'Team Categories',        'backend team', 'presscore' )
		);
...
class Presscore_Inc_Logos_Post_Type {
	...
	public static function register() {
		...
		// titles
		$labels = array(
			'name'                  => _x('Partners, Clients, etc.',    'backend logos', 'presscore'),
			'singular_name'         => _x('Partner,Client, etc.',              			'backend logos', 'presscore'),
			'add_new'               => _x('Add New Logo',                	'backend logos', 'presscore'),
			'add_new_item'          => _x('Add New Logo',           	'backend logos', 'presscore'),
			'edit_item'             => _x('Edit Partner,Client, etc.',              	'backend logos', 'presscore'),
			'new_item'              => _x('New Item',               	'backend logos', 'presscore'),
			'view_item'             => _x('View Item',              	'backend logos', 'presscore'),
			'search_items'          => _x('Search Items',           	'backend logos', 'presscore'),
			'not_found'             => _x('No items found',         	'backend logos', 'presscore'),
			'not_found_in_trash'    => _x('No items found in Trash',	'backend logos', 'presscore'), 
			'parent_item_colon'     => '',
			'menu_name'             => _x('Partners, Clients, etc.', 	'backend logos', 'presscore')
		);
		...
		// titles
		$labels = array(
			'name'              => _x( 'Logo Categories',        'backend partners', 'presscore' ),
			'singular_name'     => _x( 'Logo Category',          'backend partners', 'presscore' ),
			'search_items'      => _x( 'Search in Category','backend partners', 'presscore' ),
			'all_items'         => _x( 'Logo Categories',        'backend partners', 'presscore' ),
			'parent_item'       => _x( 'Parent Category',   'backend partners', 'presscore' ),
			'parent_item_colon' => _x( 'Parent Category:',  'backend partners', 'presscore' ),
			'edit_item'         => _x( 'Edit Category',     'backend partners', 'presscore' ), 
			'update_item'       => _x( 'Update Category',   'backend partners', 'presscore' ),
			'add_new_item'      => _x( 'Add New Logo Category',  'backend partners', 'presscore' ),
			'new_item_name'     => _x( 'New Logo Category Name', 'backend partners', 'presscore' ),
			'menu_name'         => _x( 'Logo Categories',        'backend partners', 'presscore' )
		);
...
if ( !class_exists('Presscore_Inc_Benefits_Post_Type') ):
	...
	class Presscore_Inc_Benefits_Post_Type {
		...
		public static function register() {
			...
			// titles
			$labels = array(
				'name'                  => _x('Benefits',					'backend benefits', 'presscore'),
				'singular_name'         => _x('Benefit',              			'backend benefits', 'presscore'),
				'add_new'               => _x('Add New Benefit',                	'backend benefits', 'presscore'),
				'add_new_item'          => _x('Add New Benefit',           	'backend benefits', 'presscore'),
				'edit_item'             => _x('Edit Item',              	'backend benefits', 'presscore'),
				'new_item'              => _x('New Item',               	'backend benefits', 'presscore'),
				'view_item'             => _x('View Item',              	'backend benefits', 'presscore'),
				'search_items'          => _x('Search Items',           	'backend benefits', 'presscore'),
				'not_found'             => _x('No items found',         	'backend benefits', 'presscore'),
				'not_found_in_trash'    => _x('No items found in Trash',	'backend benefits', 'presscore'), 
				'parent_item_colon'     => '',
				'menu_name'             => _x('Benefits',					'backend benefits', 'presscore')
			);
			...
			// titles
			$labels = array(
				'name'              => _x( 'Benefit Categories',        'backend partners', 'presscore' ),
				'singular_name'     => _x( 'Benefit Category',          'backend partners', 'presscore' ),
				'search_items'      => _x( 'Search in Category','backend partners', 'presscore' ),
				'all_items'         => _x( 'Benefit Categories',        'backend partners', 'presscore' ),
				'parent_item'       => _x( 'Parent Category',   'backend partners', 'presscore' ),
				'parent_item_colon' => _x( 'Parent Category:',  'backend partners', 'presscore' ),
				'edit_item'         => _x( 'Edit Category',     'backend partners', 'presscore' ), 
				'update_item'       => _x( 'Update Category',   'backend partners', 'presscore' ),
				'add_new_item'      => _x( 'Add New Benefit Category',  'backend partners', 'presscore' ),
				'new_item_name'     => _x( 'New Benefit Category Name', 'backend partners', 'presscore' ),
				'menu_name'         => _x( 'Benefit Categories',        'backend partners', 'presscore' )
			);
...
class Presscore_Inc_Albums_Post_Type {
	...
	public static function register() {
		...
		// titles
		$labels = array(
			'name'                  => _x('Photo Albums', 'backend albums', 'presscore'),
			'singular_name'         => _x('Photo Album', 'backend albums', 'presscore'),
			'add_new'               => _x('Add New Album', 'backend albums', 'presscore'),
			'add_new_item'          => _x('Add New Album', 'backend albums', 'presscore'),
			'edit_item'             => _x('Edit Album', 'backend albums', 'presscore'),
			'new_item'              => _x('New Album', 'backend albums', 'presscore'),
			'view_item'             => _x('View Album', 'backend albums', 'presscore'),
			'search_items'          => _x('Search for Albums', 'backend albums', 'presscore'),
			'not_found'             => _x('No Albums Found', 'backend albums', 'presscore'),
			'not_found_in_trash'    => _x('No Albums Found in Trash', 'backend albums', 'presscore'), 
			'parent_item_colon'     => '',
			'menu_name'             => _x('Photo Albums', 'backend albums', 'presscore')
		);
		...
		// titles
		$labels = array(
			'name'              => _x( 'Album Categories',            'backend albums', 'presscore' ),
			'singular_name'     => _x( 'Album Category',              'backend albums', 'presscore' ),
			'search_items'      => _x( 'Search in Category',    'backend albums', 'presscore' ),
			'all_items'         => _x( 'Photo Album Categories',            'backend albums', 'presscore' ),
			'parent_item'       => _x( 'Parent Category',       'backend albums', 'presscore' ),
			'parent_item_colon' => _x( 'Parent Category:',      'backend albums', 'presscore' ),
			'edit_item'         => _x( 'Edit Category',         'backend albums', 'presscore' ), 
			'update_item'       => _x( 'Update Category',       'backend albums', 'presscore' ),
			'add_new_item'      => _x( 'Add New Album Category',      'backend albums', 'presscore' ),
			'new_item_name'     => _x( 'New Album Category Name',     'backend albums', 'presscore' ),
			'menu_name'         => _x( 'Album Categories',            'backend albums', 'presscore' )
		);
...
class Presscore_Inc_Slideshow_Post_Type {
	...
	public static function register() {
		...
		// titles
		$labels = array(
			'name'                  => _x('Slideshows', 'backend albums', 'presscore'),
			'singular_name'         => _x('Slider', 'backend albums', 'presscore'),
			'add_new'               => _x('Add New', 'backend albums', 'presscore'),
			'add_new_item'          => _x('Add New Slider', 'backend albums', 'presscore'),
			'edit_item'             => _x('Edit Slider', 'backend albums', 'presscore'),
			'new_item'              => _x('New Slider', 'backend albums', 'presscore'),
			'view_item'             => _x('View Slider', 'backend albums', 'presscore'),
			'search_items'          => _x('Search for Slideshow', 'backend albums', 'presscore'),
			'not_found'             => _x('No Slideshow Found', 'backend albums', 'presscore'),
			'not_found_in_trash'    => _x('No Slideshow Found in Trash', 'backend albums', 'presscore'), 
			'parent_item_colon'     => '',
			'menu_name'             => _x('Slideshows', 'backend albums', 'presscore')
		);
