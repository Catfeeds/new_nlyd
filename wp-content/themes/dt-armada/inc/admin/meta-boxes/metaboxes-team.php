...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Display Team Members by Category(s)', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			...
			'desc'				=> sprintf(
				...
				_x( 'ALL your Team  Members are being displayed on this page!', 'backend', 'presscore' ),
				_x( 'By default all your Team Members will be displayed on this page. ', 'backend', 'presscore' ),
				_x( 'But you can specify which Team  Members categories will (or will not) be shown.', 'backend', 'presscore' ),
				_x( 'In tabs above you can select from the following options:', 'backend', 'presscore' ),

				_x( 'All', 'backend', 'presscore' ),

				_x( ' &mdash; all Team  Members (from all categories) will be shown on this page.', 'backend', 'presscore' ),

				_x( 'Only', 'backend', 'presscore' ),

				_x( ' &mdash; choose Team category(s) to be shown on this page.', 'backend', 'presscore' ),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Team Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'gap between images', array(
			...
			'name'	=> _x( 'Gap between team members (px):', 'backend metabox', 'presscore' ),
			'desc'	=> _x( 'Team member paddings (e.g. 5 pixel padding will give you 10 pixel gaps between team members)', 'backend metabox', 'presscore' ),
		) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'background under post', array( 'id' => "{$prefix}bg_under_posts", 'name' => _x( 'Background under team members:', 'backend metabox', 'presscore' ) ) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array(
			...
			'name'		=> _x( 'Show team members excerpts:','backend metabox', 'presscore' ),
			'divider'	=> 'top'
		) ),

		// Number of posts to display on one page
		array(
			'name'		=> _x( 'Number of team members on one page:', 'backend metabox', 'presscore' ),
			'id'		=> "{$prefix}ppp",
			'type'		=> 'text',
			'std'		=> '',
			'divider'	=> 'top'
...
$teammate_fields = array(
	...
	Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array(
		...
		'name'		=> _x( 'Link to teammate details page:','backend metabox', 'presscore' ),
		'divider'	=> 'bottom'
	) ),

	// Position
	array(
		'name'	=> _x('Position:', 'backend metabox', 'presscore'),
		'id'    => "{$prefix}position",
		'type'  => 'textarea',
		'std'   => '',
	),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'dt_team' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
