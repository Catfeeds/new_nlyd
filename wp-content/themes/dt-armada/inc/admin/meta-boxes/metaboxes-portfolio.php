...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Display Portfolio Category(s)', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			...
			'desc'				=> sprintf(
				...
				_x('ALL your Portfolio projects are being displayed on this page!', 'backend', 'presscore'),
				_x('By default all your Portfolio projects will be displayed on this page. ', 'backend', 'presscore'),
				_x('But you can specify which Portfolio project category(s) will (or will not) be shown.', 'backend', 'presscore'),
				_x('In tabs above you can select from the following options:', 'backend', 'presscore'),

				_x( 'All', 'backend', 'presscore' ),

				_x(' &mdash; all Projects will be shown on this page.', 'backend', 'presscore'),

				_x( 'Only', 'backend', 'presscore' ),

				_x(' &mdash; choose Project category(s) to be shown on this page.', 'backend', 'presscore'),

				_x( 'All, except', 'backend', 'presscore' ),

				_x(' &mdash; choose which Project category(s) will be excluded from displaying on this page.', 'backend', 'presscore')
			)
		)
	),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Portfolio Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'background under post', array(
			'name'				=> _x( 'Background under projects:', 'backend metabox', 'presscore' ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover background color', array(
			'name'				=> _x( 'Image rollover color:', 'backend metabox', 'presscore' ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'description style', array(
			'name'				=> _x( 'Show projects descriptions:', 'backend metabox', 'presscore' ),
		...
		array(
			'name'    			=> _x( 'Make all projects the same width:', 'backend metabox', 'presscore' ),
		...
		array(
			'name'		=> _x( 'Number of projects to display on one page:', 'backend metabox', 'presscore' ),
			'id'		=> "{$prefix}ppp",
			'type'		=> 'text',
			'std'		=> '',
			'divider'	=> 'top'
		...
		array(
			...
			'name'		=> _x( 'Show projects titles:', 'backend metabox', 'presscore' ),
		...
		array(
			'name'    	=> _x('Show projects excerpts:', 'backend metabox', 'presscore'),
		...
		// categories
		array(
			'name'    	=> _x('Show project categories:', 'backend metabox', 'presscore'),
		...
		// date
		array(
			'name'    	=> _x('Show project date:', 'backend metabox', 'presscore'),
		...
		// author
		array(
			'name'    	=> _x('Show project author:', 'backend metabox', 'presscore'),
		...
		// comments
		array(
			'name'    	=> _x('Show project comments:', 'backend metabox', 'presscore'),
		...
		// details
		array(
			'name'    	=> _x('Show details icons:', 'backend metabox', 'presscore'),
		...
		// links
		array(
			'name'    	=> _x('Show links icons:', 'backend metabox', 'presscore'),
		...
		// zoom
		array(
			'name'    	=> _x('Show zoom icons:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}show_zoom",
			'type'    	=> 'radio',
			'std'		=> '1',
			'options'	=> $yes_no_options,
		...
		array(
			...
			'name'    	=> _x('Show details buttons:', 'backend metabox', 'presscore'),
		...
		array(
			'name'    	=> _x('Show categories filter:', 'backend metabox', 'presscore'),
		...
		// Orderby
		array(
			'name'     	=> _x('Orderby:', 'backend metabox', 'presscore'),
			'id'       	=> "{$prefix}orderby",
			'type'     	=> 'select',
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Add/Edit Project Media', 'backend metabox', 'presscore'),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Media Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'dt_portfolio' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		// Layout settings
		array(
			'name'    	=> _x('Layout settings:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}layout",
			'type'    	=> 'radio',
			'std'		=> 'left',
			'options'	=> array(
				'left'		=> array( _x('Media on the left of content', 'backend metabox', 'presscore'), array('right-content.gif', 75, 50) ),
				'right' 	=> array( _x('Media on the right of content', 'backend metabox', 'presscore'), array('left-content.gif', 75, 50) ),
				'before' 	=> array( _x('Media before content area', 'backend metabox', 'presscore'), array('bottom-content.gif', 75, 50) ),
				'after' 	=> array( _x('Media after content area', 'backend metabox', 'presscore'), array('top-content.gif', 75, 50) ),
				'disabled' 	=> array( _x('Media disabled (blank page)', 'backend metabox', 'presscore'), array('no-media-content.gif', 75, 50) ),
			),
			'hide_fields'	=> array(
		...
		// Fixed background
		array(
			'name'    		=> _x('Enable floating content:', 'backend metabox', 'presscore'),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Project Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'dt_portfolio' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			'name'    		=> _x('Project link:', 'backend metabox', 'presscore'),
			'id'      		=> "{$prefix}show_link",
			'type'    		=> 'checkbox',
			'std'			=> 0,
			'hide_fields'	=> array(
		...
		// Link
		array(
			'name'	=> _x('Link:', 'backend metabox', 'presscore'),
			'id'    => "{$prefix}link",
			'type'  => 'text',
			'std'   => '',
		),
		...
		// Link name
		array(
			'name'	=> _x('Caption:', 'backend metabox', 'presscore'),
			'id'    => "{$prefix}link_name",
			'type'  => 'text',
			'std'   => '',
		),
		...
		// Target
		array(
			'name'    	=> _x('Target:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}link_target",
			'type'    	=> 'radio',
			'std'		=> '',
			'options'	=> array(
				''			=> _x('_self', 'backend metabox', 'presscore'),
				'_blank' 	=> _x('_blank', 'backend metabox', 'presscore'),
			),
		),
		...
		array(
			'name'    		=> _x('Hide featured image on project page:', 'backend metabox', 'presscore'),
		...
		array(
			'name'    		=> _x('Open images in lightbox:', 'backend metabox', 'presscore'),
		...
		array(
			'name'    	=> _x('Related projects category:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}related_mode",
			'type'    	=> 'radio',
			'std'		=> 'same',
			'options'	=> array(
				'same'		=> _x('from the same category', 'backend metabox', 'presscore'),
				'custom'	=> _x('choose category(s)', 'backend metabox', 'presscore'),
			),
			'hide_fields'	=> array(
		...
		array(
			'name'    	=> _x('Project preview width:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}preview",
			'type'    	=> 'radio',
			'std'		=> 'normal',
			'options'	=> array(
			...
			'before'	=> '<p><small>' . sprintf(
				_x('Related projects can be enabled / disabled from %sTheme Options / Blog, Portfolio, Gallery%s', 'backend metabox', 'presscore'),
				'<a href="' . esc_url( add_query_arg( 'page', 'of-blog-and-portfolio-menu', get_admin_url() . 'admin.php' ) ) . '" target="_blank">',
				'</a>'
			) . '</small></p><div class="dt_hr"></div><p><strong>' . _x('Project Preview Options', 'backend metabox', 'presscore') . '</strong></p>'
		),
		...
		array(
			'name'    	=> _x('Preview style:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}preview_style",
			'type'    	=> 'radio',
			'std'		=> 'featured_image',
			'options'	=> array(
				'featured_image'	=> _x('featured image', 'backend metabox', 'presscore'),
				'slideshow'			=> _x('slideshow', 'backend metabox', 'presscore'),
			),
			'hide_fields'	=> array(
