...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Display Testimonials Category(s)', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			...
			'desc'				=> sprintf(
				...
				_x( 'ALL your Testimonials are being displayed on this page!', 'backend', 'presscore' ),
				_x( 'By default all your Testimonials will be displayed on this page. ', 'backend', 'presscore' ),
				_x( 'But you can specify which Testimonials categories will (or will not) be shown.', 'backend', 'presscore' ),
				_x( 'In tabs above you can select from the following options:', 'backend', 'presscore' ),

				_x( 'All', 'backend', 'presscore' ),

				_x( ' &mdash; all Testimonials (from all categories) will be shown on this page.', 'backend', 'presscore' ),

				_x( 'Only', 'backend', 'presscore' ),

				_x( ' &mdash; choose Testimonials category(s) to be shown on this page.', 'backend', 'presscore' ),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x( 'Testimonials Options', 'backend metabox', 'presscore' ),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'gap between images', array(
			'name'	=> _x( 'Gap between testimonials (px):', 'backend metabox', 'presscore' ),
		...
		array(
			'name'		=> _x( 'Number of testimonials on one page:', 'backend metabox', 'presscore' ),
			'id'		=> "{$prefix}ppp",
			'type'		=> 'text',
			'std'		=> '',
			'divider'	=> 'top'
