...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Display Photo & Video Albums', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			...
			'desc' => sprintf(
				...
				_x( 'ALL your Photo & Video albums are being displayed on this page!', 'backend', 'presscore' ),
				_x( 'By default all your Albums will be displayed on this page. ', 'backend', 'presscore' ),
				_x( 'But you can specify which Album(s) or Album category(s) will (or will not) be shown.', 'backend', 'presscore' ),
				_x( 'In tabs above you can select from the following options:', 'backend', 'presscore' ),

				_x( 'All', 'backend', 'presscore' ),

				_x( ' &mdash; all Albums will be shown on this page.', 'backend', 'presscore' ),

				_x( 'Only', 'backend', 'presscore' ),

				_x( ' &mdash; choose Album(s) or Album category(s) to be shown on this page.', 'backend', 'presscore' ),

				_x( 'All, except', 'backend', 'presscore' ),

				_x( ' &mdash; choose which Album(s) or Album category(s) will be excluded from displaying on this page.', 'backend', 'presscore' )
			)
		)
	),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Albums Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'description style', array(
			...
			'name'				=> _x( 'Show albums descriptions:', 'backend metabox', 'presscore' ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'background under masonry post', array(
			'name'				=> _x( 'Background under album:', 'backend metabox', 'presscore' ),
		...
		array(
			...
			'name'    			=> _x( 'Make all albums the same width:', 'backend metabox', 'presscore' ),
			'type'    			=> 'checkbox',
			'std'				=> 0,
			'divider'			=> 'top',
			'show_on_template'	=> 'template-albums.php'
		...
		array(
			'name'		=> _x( 'Number of albums to display on one page:', 'backend metabox', 'presscore' ),
			'id'    	=> "{$prefix}ppp",
			'type'  	=> 'text',
			'std'   	=> '',
			'divider'	=> 'top'
		...
		array(
			...
			'name'    	=> _x( 'Show albums titles:', 'backend metabox', 'presscore' ),
		...
		// Show excerpts
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_exerpts", 'name' => _x( 'Show albums excerpts:', 'backend metabox', 'presscore' ) ) ),
		...
		// Show categories
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_categories_in_post_meta", 'name' => _x( 'Show album categories:', 'backend metabox', 'presscore' ) ) ),

		// Show date
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_date_in_post_meta", 'name' => _x( 'Show album date:', 'backend metabox', 'presscore' ) ) ),

		// Show author
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_author_in_post_meta", 'name' => _x( 'Show album author:', 'backend metabox', 'presscore' ) ) ),

		// Show comments
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_comments_in_post_meta", 'name' => _x( 'Show album comments:', 'backend metabox', 'presscore' ) ) ),

		// Show media numbers
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_numbers_in_post_meta", 'name' => _x( 'Show number of images &amp; videos:', 'backend metabox', 'presscore' ) ) ),

		// Show posts filter
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array(
			'id'		=> "{$prefix}show_filter",
			'name'		=> _x( 'Show albums filter:', 'backend metabox', 'presscore' ),
			'divider'	=> 'top'
		) ),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Display Photos & Videos', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			...
			'desc'				=> sprintf(
				...
				_x('ALL Photos & Videos from all your Albums are being displayed on this page!', 'backend', 'presscore'),
				_x('By default all your Photos & Videos will be displayed on this page. ', 'backend', 'presscore'),
				_x('But you can specify which Album(s) or Album category(s) will (or will not) be shown.', 'backend', 'presscore'),
				_x('In tabs above you can select from the following options:', 'backend', 'presscore'),

				_x( 'All', 'backend', 'presscore' ),

				_x(' &mdash; all Photos & Videos from all Albums will be shown on this page.', 'backend', 'presscore'),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Gallery Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		// Number of posts to display on one page
		array(
			'name'		=> _x( 'Number of items to display on one page:', 'backend metabox', 'presscore' ),
			'id'    	=> "{$prefix}ppp",
			'type'  	=> 'text',
			'std'   	=> '',
			'divider'	=> 'top'
		...
		array(
			'name'    	=> _x('Show items titles:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}show_titles",
			'type'    	=> 'radio',
			'std'		=> '1',
		...
		// Show excerpts
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_exerpts", 'name' => _x( 'Show items descriptions:', 'backend metabox', 'presscore' ) ) ),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Add/Edit Media', 'backend metabox', 'presscore'),
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Album Options', 'backend metabox', 'presscore'),
	'pages' 	=> array( 'dt_gallery' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			'name'     		=> _x('Open album:', 'backend metabox', 'presscore'),
			'id'       		=> "{$prefix}open_album",
			'type'     		=> 'radio',
			'std'			=> 'lightbox',
			'options'  		=> array(
				'lightbox' => _x( 'Lightbox', 'backend metabox', 'presscore' ),
				'post' => _x( 'Album page', 'backend metabox', 'presscore' )
			),
			'bottom_divider'	=> true
		),
		...
		array(
			'name'    	=> _x('Show media as:', 'backend metabox', 'presscore'),
			'id'      	=> "{$prefix}type",
			'type'    	=> 'radio',
			'std'		=> 'slideshow',
			'options'	=> array(
				'slideshow'			=> array( _x('Slideshow', 'backend metabox', 'presscore'), array('layout-slider.gif', 75, 50) ),
				'gallery' 			=> array( _x('Gallery', 'backend metabox', 'presscore'), array('layout-metro.gif', 75, 50) ),
				'list'				=> array( _x('List', 'backend metabox', 'presscore'), array('layout-list.gif', 75, 50) ),
				'photo_scroller' 	=> array( _x('PhotoScroller', 'backend metabox', 'presscore'), array('photoscroller.gif', 75, 50) )
			),
			'hide_fields'		=> array(
				'gallery' 			=> array( "{$prefix}slider_proportions", "{$prefix}photo_scroller_container" ),
				'list'				=> array( "{$prefix}slider_proportions", "{$prefix}gallery_container", "{$prefix}photo_scroller_container" ),
				'slideshow'			=> array( "{$prefix}gallery_container", "{$prefix}photo_scroller_container" ),
				'photo_scroller'	=> array( "{$prefix}slider_proportions", "{$prefix}gallery_container" )
			)
		),
		...
		array(
			...
			'name'     		=> _x('Columns:', 'backend metabox', 'presscore'),
		...
		array(
			'name'    		=> _x('Make first image large:', 'backend metabox', 'presscore'),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'opacity slider', array(
			'name'		=> _x( 'Inactive image opacity (%):', 'backend metabox', 'presscore' ),
		...
		array(
			'name'    	=> _x( 'Exclude featured image from the album:', 'backend metabox', 'presscore' ),
		...
		array(
			'name'    	=> _x( 'Album preview width:', 'backend metabox', 'presscore' ),
			'id'      	=> "{$prefix}preview",
			'type'    	=> 'radio',
			'std'		=> 'normal',
			'options'	=> array(
