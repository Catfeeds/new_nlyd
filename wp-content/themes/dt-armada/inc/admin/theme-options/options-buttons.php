 ...
 */
$options[] = array(
	"page_title"	=> _x( "Buttons", 'theme-options', 'presscore' ),
	"menu_title"	=> _x( "Buttons", 'theme-options', 'presscore' ),
 ...
 * Heading definition.
 */
$options[] = array( "name" => _x('Buttons', 'theme-options', 'presscore'), "type" => "heading" );

/**
 * Buttons style.
 */
$options[] = array( "name" => _x("Buttons style", "theme-options", 'presscore'), "type" => "block_begin" );
	...
	$options["buttons-style"] = array(
		...
		"type"		=> "radio",
		"options"	=> array(
			"flat"	=> _x( "Flat", "theme-options", 'presscore' ),
			"3d"	=> _x( "3D", "theme-options", 'presscore' )
		)
	);
 ...
 * Buttons color.
 */
$options[] = array( "name" => _x("Buttons color", "theme-options", 'presscore'), "type" => "block_begin" );
	...
	$options["buttons-color_mode"] = array(
		"name"		=> _x( "Buttons color", "theme-options", 'presscore' ),
...
foreach ( $buttons as $id=>$opts ) {
	...
	$options[] = array(	"name" => _x($opts['desc'], 'theme-options', 'presscore'), "type" => "block_begin" );
