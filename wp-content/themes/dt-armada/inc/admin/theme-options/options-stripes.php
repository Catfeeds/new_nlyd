 ...
 */
$options[] = array(
		"page_title"	=> _x( "Stripes", 'theme-options', 'presscore' ),
		"menu_title"	=> _x( "Stripes", 'theme-options', 'presscore' ),
...
foreach ( presscore_themeoptions_get_stripes_list() as $suffix=>$stripe ) {
	...
	$options[] = array(	"name" => $stripe['title'], "type" => "block_begin" );
		...
		// title
		$options[] = array( "type" => 'title', "name" => _x('Background', 'theme-options', 'presscore') );
		...
		// title
		$options[] = array( "type" => 'title', "name" => _x( 'Text', 'theme-options', 'presscore' ) );
