...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => _x('no repeat', 'theme-options', 'presscore'),
		'repeat-x'  => _x('repeat x', 'theme-options', 'presscore'),
		'repeat-y'  => _x('repeat y', 'theme-options', 'presscore'),
		'repeat'    => _x('repeat', 'theme-options', 'presscore'),
		);
...
function of_recognized_background_vertical_position() {
	$default = array(
		'top' 		=> _x('top', 'theme-options', 'presscore'),
		'bottom'	=> _x('bottom', 'theme-options', 'presscore'),
		'center'	=> _x('center', 'theme-options', 'presscore'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => _x('Top Left', 'theme-options', 'presscore'),
		'top center'    => _x('Top Center', 'theme-options', 'presscore'),
		'top right'     => _x('Top Right', 'theme-options', 'presscore'),
		'center left'   => _x('Middle Left', 'theme-options', 'presscore'),
		'center center' => _x('Middle Center', 'theme-options', 'presscore'),
		'center right'  => _x('Middle Right', 'theme-options', 'presscore'),
		'bottom left'   => _x('Bottom Left', 'theme-options', 'presscore'),
		'bottom center' => _x('Bottom Center', 'theme-options', 'presscore'),
		'bottom right'  => _x('Bottom Right', 'theme-options', 'presscore')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => _x('Scroll Normally', 'theme-options', 'presscore'),
		'fixed'  => _x('Fixed in Place', 'theme-options', 'presscore')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => _x( 'Normal', 'theme-options', 'presscore' ),
		'italic'      => _x( 'Italic', 'theme-options', 'presscore' ),
		'bold'        => _x( 'Bold', 'theme-options', 'presscore' ),
		'bold italic' => _x( 'Bold Italic', 'theme-options', 'presscore' )
		);
