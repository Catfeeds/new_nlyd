...
function optionsframework_get_menu_items() {
	...
	array_unshift( $menu_items, array( 'page_title' => _x( 'General', 'backend', 'presscore' ), 'menu_title' => _x( 'General', 'backend', 'presscore' ), 'main_title' => _x( 'Theme Options', 'backend', 'presscore' ) , 'menu_slug' => 'options-framework') );
		...
		<div id="optionsframework">
			...
			<div id="submit-wrap">
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'presscore' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'presscore' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to restore default settings on this page!', 'presscore' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
			</div>
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'presscore' ), 'updated fade' );
		$current = null;
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', _x( 'Options saved.', 'backend', 'presscore' ), 'updated fade' );
}
