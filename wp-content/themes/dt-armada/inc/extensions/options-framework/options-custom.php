...
function optionsframework_widgetareas_interface( $output, $value ) {
    ...
    // Name
    $output .= '<label for="widgetareas-name">' . _x('Sidebar name', 'theme-options', 'presscore') . '</label>';
    $output .= '<input type="text" id="widgetareas-name" class="of_fields_gen_title" value=""/>';

    // Description
	$output .= '<label for="widgetareas-description">' . _x('Sidebar description (optional)', 'theme-options', 'presscore') . '</label>';
    $output .= '<textarea id="widgetareas-description"></textarea>';    

    // Button
    $output .= '<button id="widgetareas-add" class="of_fields_gen_add">' . _x('Update', 'theme-options', 'presscore') . '</button>';
