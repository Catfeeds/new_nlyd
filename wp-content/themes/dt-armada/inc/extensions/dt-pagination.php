...
function dt_paginator( $query = null, $opts = array() ) {
	...
	if ( !is_single() ) {
		$defaults = array(
			...
			'pages_text'        => _x( 'Page %CURRENT_PAGE% of %TOTAL_PAGES%', 'pagination defaults', 'presscore' ),
			'current_text'      => '%PAGE_NUMBER%',
			'page_text'         => '%PAGE_NUMBER%',
			'first_text'        => _x( 'First', 'pagination defaults', 'presscore' ),
			'last_text'         => _x( 'Last', 'pagination defaults', 'presscore' ),
			'prev_text'         => '<',
			'next_text'         => '>',
			'no_next'			=> '',
			'no_prev'			=> '',
