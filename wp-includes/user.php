...
function wp_insert_user( $userdata ) {
    ...
    if(!empty($userdata['user_mobile'])){
         $data['user_mobile'] = $userdata['user_mobile'];
    }
 ...
 *                      be created.
 */
function wp_create_user($username, $password, $email = '',$mobile='') {
	$user_login = wp_slash( $username );
	$user_email = wp_slash( $email    );
	$user_mobile = wp_slash( $mobile    );
	$user_pass = $password;

	$userdata = compact('user_login', 'user_email', 'user_pass','user_mobile');
